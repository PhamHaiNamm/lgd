              ...
              <div className="container-fluid p-0">
                ...
                <div className="collapse navbar-collapse" id="navbarNavDropdown">
                  <ul className="navbar-nav gap-3 align-items-center">
                    ...
                    <li className="nav-item">
                      <Link to="/social" className="nav-link text-white fw-bold px-3 position-relative">
                        Mạng xã hội
                      </Link>
                    </li>
                    <li className="nav-item">
                      <Link to="/chat" className="nav-link text-white fw-bold px-3 position-relative">
                        Nhắn tin
                        <span className="badge ms-2" style={{ fontSize: '0.7rem', background: '#8b5cf6', color: '#fff' }}>CHAT</span>
                      </Link>
                    </li>
                    <li className="nav-item">
          ...
          <div className="col-3 col-md-3 col-lg-2 text-end d-flex align-items-center justify-content-end">
            {user ? (
              <div className="dropdown d-inline-block">
                ...
                >
                  {user.name || user.username} ({user.role === 'admin' ? 'Admin' : 'TV'})
                </button>
              ...
              <Link to="/login" className="btn btn-sm btn-outline-light px-3 fw-bold">
                Đăng nhập
              </Link>
            )}
          </div>
